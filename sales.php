...
<head>
    ...
    <title>Sales Report - Point of Sale & Inventory Management System</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><span>MMS SHOP POINT OF SALE & INVENTORY MANAGEMENT SYSTEM</span></div>
                </nav>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span>QR<?php include_once 'functions/dashboard-today-sales.php'; ?></span></div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span>QR<?php include_once 'functions/dashboard-month-sales.php'; ?></span></div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span>QR<?php include_once 'functions/dashboard-year-sales.php'; ?></span></div>
                                            <div class="text-dark fw-bold h5 mb-0"></div>
                                        </div>
                                        <div class="col-auto"><i class="fas fa-dollar-sign fa-2x text-gray-300"></i></div>
                                    </div>
