...
<head>
    ...
    <title>POS - Point of Sale & Inventory Management System</title>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h4 class="display-4 fw-bold card-title">QR <?php include_once 'functions/pos-total.php'; ?></h4>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card">
                            <div class="card-body text-center p-4">
                                <h6 class="text-uppercase text-muted card-subtitle">TOTAL</h6>
                                <h4 class="display-4 fw-bold card-title">QR <?php include 'functions/pos-total.php'; ?></h4>
